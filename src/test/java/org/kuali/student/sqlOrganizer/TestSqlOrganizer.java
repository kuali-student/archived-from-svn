...
public class TestSqlOrganizer {
    ...
    public static SqlOrganizer getTestSqlOrganizer() {
        ...
        String projectPath = "C:\\data\\development\\intellijProjects\\enr-aggregate";
        String outputDirPath = getTestOutputDirPath();
        sqlOrganizer.init(dataTypeTableSets, projectPath, outputDirPath);

        return sqlOrganizer;
    }

    public static String getTestOutputDirPath() {
        return "C:\\data\\development\\sql-organizer-output-enrfr2-m1\\";
    }
