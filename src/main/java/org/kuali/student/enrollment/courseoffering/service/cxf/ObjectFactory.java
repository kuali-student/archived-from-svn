...
public class ObjectFactory {
    ...
    private final static QName _ReturnType_QNAME = new QName("http://apache.org/callback", "returnType");
    private final static QName _CallbackMessage_QNAME = new QName("http://apache.org/callback", "callback_message");
    private final static QName _SubscribeToActivityOfferings_QNAME = new QName("http://apache.org/callback", "SubscribeToActivityOfferings");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://apache.org/callback", name = "SubscribeToActivityOfferings")
