@nightly @yellow_team
Feature: CO.AZ Dept Schedule Coordinator SOC state Open
  ...
  Scenario: AZ CCO_open.2 - Department Schedule Coordinator does not have access to co-located activity offerings
    Given there is a course with a co-located activity offering in my admin org
