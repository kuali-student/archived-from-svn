When(/^I apply a hold to student by completing the required information$/) do
  @applied_hold = create AppliedHold, :student_id => "KS-2052", :hold_issue => (make HoldIssue, :code => "ADMIS02")
...
When(/^I apply a term based hold to student by completing the required information$/) do
  @applied_hold = create AppliedHold, :student_id => "KS-2053", :find_code_by_lookup => true,
