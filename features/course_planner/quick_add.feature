...
Feature: BT.Quick Add
  ...
  Scenario: PL 4.0.1 Add course to the backup section from quick add in the planner
  ...
  Scenario: PL 4.0.2 Do not allow  duplicate course to be added to the same backup section in the term
    When I add a course from the quick add to the backup section in the planner
