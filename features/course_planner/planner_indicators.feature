...
Feature: BT.Planner Indicators and Real Time Data
  ...
  Scenario: VP 5.0.3 Verify the indicator for a course planned for suspended registration groups
    When I navigate to the planner page to view a course planned for suspended registration groups
  ...
  Scenario: VP 5.0.4 Verify the indicator for a course planned for suspended or cancelled course offering
    When I navigate to the planner page to view a course planned for cancelled course offering
