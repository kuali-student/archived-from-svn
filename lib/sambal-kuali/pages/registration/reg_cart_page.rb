class RegistrationCart < RegisterForCourseBase
  ...
  value(:ao_type) { |course_code,reg_group_code,index,b| b.span(id: "ao_type_long_#{course_code}_#{reg_group_code}_#{index}").text }
  value(:ao_type_div) { |course_code,reg_group_code,index,b| b.div(id: "ao_type_#{course_code}_#{reg_group_code}_#{index}").text }
  ...
  element(:reason_message_span) { |course_code,reg_group_code,b| b.span(id: "reason_message_#{course_code}_#{reg_group_code}") }
