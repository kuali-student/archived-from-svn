class CmRetirementInformationPage < BasePage
  ...
  element(:modify_retirement_rationale) {|b|b.textarea(id: "CM-Modify-RetireCourse-Rationale_control")}
  ...
  element(:modify_last_term_offered) {|b|b.select_list(id: "CM-Modify-RetireCourse-LastTerm_control")}
