class EditAcademicCalendar < BasePage
  ...
  action(:confirm_delete) { |b| sleep 5; b.delete_dialog_div.radio(index: 0).click; b.loading.wait_while_present }
  action(:cancel_delete) { |b| sleep 5; b.delete_dialog_div.radio(index: 1).click ; b.loading.wait_while_present}
  ########
