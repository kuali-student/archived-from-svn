...
action(:find_a_proposal) { |b| b.button(id: "CM-FindProposal-Lookup-Search").click; b.loading_wait }
...
action(:review_proposal_action_link) { |proposal_title,b| b.a(id: "#{proposal_title}_view").i(class: "ks-fontello-icon-eye" ).click; b.loading_wait }
action(:edit_proposal_element) { |proposal_title,b| b.a(id: "#{proposal_title}_edit").i(class: "ks-fontello-icon-pencil") }
action(:edit_proposal_action) { |proposal_title,b| b.a(id: "#{proposal_title}_edit").i(class: "ks-fontello-icon-pencil").click; b.loading_wait }
