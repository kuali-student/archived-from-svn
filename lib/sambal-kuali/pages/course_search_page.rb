class CourseSearch < BasePage
  ...
  wrapper_elements
  frame_element
  expected_element :search_for_course,120
  ...
  element(:bookmark_count_coursesearch) { |b|b.div(class:"ksapBookmarkCount").span(id:"Ksap-Header-Bookmark-Count-Value")}
  ...
  element(:backup_checkbox) { |b|b.checkbox(id:/control/)}
  ...
  element(:star_bookmark_on) {|b|b.a(id:/bookmark_anchor/,class:"ks-fontello-icon-star")}
